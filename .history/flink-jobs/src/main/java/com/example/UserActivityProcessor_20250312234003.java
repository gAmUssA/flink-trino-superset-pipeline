    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<RowData> rowDataStream = kafkaStream.map(new MapFunction<String, RowData>() {
            ...
            public RowData map(String value) throws Exception {
                ...
                if (jsonNode.has("total_amount")) {
                    row.setField(7, jsonNode.get("total_amount").asDouble());
                } else {
                    row.setField(7, null);
                }
        ...
        // Temporarily commenting out Iceberg sink code
        /*
        ...
        */
        ...
        // Print the data to stdout for testing
        rowDataStream.print();
